// <copyright file="WMBusMessageResponse.cs" company="Poul Erik Venø Hansen">
...
namespace FosterBuster.IM871A.Messaging.Radio
{
    ...
    /// </summary>
    public class WMBusMessageResponse : RadioLinkMessage, IReceivable
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WMBusMessageResponse"/> class.
        /// </summary>
        /// <param name="payload">the payload.</param>
        public WMBusMessageResponse(byte[] payload)
            : base(RadioLinkMessageIdentifier.WMBusMessageRespone, payload)
        {
        }
