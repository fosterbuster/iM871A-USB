...
namespace FosterBuster.IM871A.Messaging.Device
{
    ...
    public class GetSystemStatusResponse : DeviceMessage, IReceivable
    {
        ...
        /// </summary>
        public bool ConfigurationDataIsConfigured => Payload[3].GetBit(0);

        /// <summary>
        /// Gets a value indicating whether or not Production Data is present.
        /// </summary>
        public bool ProductionDataIsConfigured => Payload[3].GetBit(1);

        /// <summary>
        /// Gets a value indicating whether or not AES Data is corrupt.
        /// </summary>
        public bool AesDataIsCorrupt => Payload[3].GetBit(2);

        /// <summary>
        /// Gets a value indicating whether or not the FFS (Fast File System) is corrupt.
        /// </summary>
        public bool FileSystemIsCorrupt => Payload[3].GetBit(7);

        /// <summary>
        /// Gets System Ticks with 10 ms resolution, updated continuously when the module is not in a power saving state.
        /// </summary>
        public int SystemTicks => BitConverter.ToInt32(Payload.Skip(6).Take(4).ToArray(), 0);

        /// <summary>
        /// Gets the number of transmitted radio messages.
        /// </summary>
        public int TransmittedFramesCount => BitConverter.ToInt32(Payload.Skip(17).Take(4).ToArray(), 0);

        /// <summary>
        /// Gets the number of not transmitted radio messages.
        /// </summary>
        public int TransmittedFramesErrorCount => BitConverter.ToInt32(Payload.Skip(21).Take(4).ToArray(), 0);

        /// <summary>
        /// Gets the number of received radio messages.
        /// </summary>
        public int ReceivedFramesCount => BitConverter.ToInt32(Payload.Skip(25).Take(4).ToArray(), 0);

        /// <summary>
        /// Gets the number of received CRC errors (radio link).
        /// </summary>
        public int ReceivedFramesCrcErrorCount => BitConverter.ToInt32(Payload.Skip(29).Take(4).ToArray(), 0);
